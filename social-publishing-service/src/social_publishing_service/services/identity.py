...
class Identity:
    ...
    def can_manage_social(self) -> bool:
        return self.is_superadmin or self.account_role in {"Owner", "Admin"}
    ...
    def verify(self, token: str) -> Identity:
        ...
        try:
            ...
            if payload["token_type"] != "access":  # noqa: S105
                raise SocialPublishingError(401, "INVALID_TOKEN", "Access token is invalid")
            return Identity(
            ...
            raise SocialPublishingError(401, "TOKEN_EXPIRED", "Access token has expired") from exc
        except (jwt.PyJWTError, KeyError, ValueError) as exc:
            raise SocialPublishingError(401, "INVALID_TOKEN", "Access token is invalid") from exc
