    ...
    def verify(self, token: str) -> Identity:
        ...
        try:
            ...
            if payload["token_type"] != "access":  # noqa: S105
                raise ScraperError(401, "INVALID_TOKEN", "Access token is invalid")
            return Identity(
            ...
            raise ScraperError(401, "TOKEN_EXPIRED", "Access token has expired") from exc
        except (jwt.PyJWTError, KeyError, ValueError) as exc:
            raise ScraperError(401, "INVALID_TOKEN", "Access token is invalid") from exc
