...
from tenant_service import __version__
from tenant_service.database import DatabaseProtocol
from tenant_service.schemas.responses import HealthResponse, ReadinessResponse
...
async def version() -> dict[str, str]:
    return {"service": "tenant-service", "version": __version__}
