...
from ai_generation_service.services.identity import Identity, IdentityServiceProtocol
...
def get_identity(
    ...
    if credentials is None or credentials.scheme.lower() != "bearer":
        raise AIServiceError(401, "AUTHENTICATION_REQUIRED", "A valid bearer token is required")
